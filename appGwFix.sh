...
az network dns record-set a delete -g core_platform -z $1.fairline.world -n @ --yes
az network dns record-set a add-record -g core_platform -z $1.fairline.world -n @ -a $ip1 --ttl 1
